...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,438 | 🐛 256 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,640 | 🐛 126 | 🌐 C++ | 📅 2026-09-09.
...
* [ArchWSL](https://github.com/yuk7/ArchWSL) ⭐ 7,404 | 🐛 64 | 🌐 Makefile | 📅 2026-04-02 - ArchLinux in WSL. ![github project][githublogo]
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,924 | 🐛 1,760 | 🌐 C++ | 📅 2026-09-18 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,756 | 🐛 341 | 🌐 Rust | 📅 2026-08-31 - A terminal emulator with focus on performance and simplicity.
...
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 487 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-18 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Manager](https://github.com/bostrot/wsl2-distro-manager) ⭐ 4,002 | 🐛 10 | 🌐 Dart | 📅 2026-09-17 - Free, open-source GUI for WSL: install distros from a catalogue or any Docker image, copy, move, back up and compact them, edit `.wslconfig`, mount disks, manage a remote host's WSL over SSH; optional AI assistant and MCP server. Also manages native Linux VMs on macOS. ![github project][githublogo]
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,790 | 🐛 11 | 🌐 Rust | 📅 2026-08-25 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
* [WSL UI](https://github.com/octasoft-ltd/wsl-ui) ⭐ 394 | 🐛 38 | 🌐 TypeScript | 📅 2026-09-03 - A lightweight desktop application for managing WSL distributions built with Tauri. ![github project][githublogo]
...
* [wip](https://github.com/slidict/wip) ⭐ 22 | 🐛 5 | 🌐 C# | 📅 2026-09-18 - A native CLI that brings dip-like development workflows to Microsoft WSL Containers (WSLC).
...
* [Files](https://github.com/files-community/Files) ⭐ 45,512 | 🐛 456 | 🌐 C# | 📅 2026-09-17 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,727 | 🐛 982 | 🌐 C++ | 📅 2026-09-18 - For reporting issues with WSL. ![github project][githublogo]
...
* [Awesome Shell](https://github.com/alebcay/awesome-shell) ⭐ 37,638 | 🐛 186 | 📅 2025-08-28
* [Awesome VSCode](https://github.com/viatsko/awesome-vscode) ⭐ 29,046 | 🐛 62 | 🌐 JavaScript | 📅 2026-06-21
