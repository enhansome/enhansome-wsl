...
* [WSL2-Linux-Kernel](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,543 | 🐛 134 | 🌐 C | 📅 2026-08-01 - The source for the Linux kernel used in Windows Subsystem for Linux 2.
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,175 | 🐛 257 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,556 | 🐛 125 | 🌐 C++ | 📅 2026-05-27.
...
* [ArchWSL](https://github.com/yuk7/ArchWSL) ⭐ 7,398 | 🐛 64 | 🌐 Makefile | 📅 2026-04-02 - ArchLinux in WSL. ![github project][githublogo]
...
* [AlpineWSL](https://github.com/yuk7/AlpineWSL) ⭐ 659 | 🐛 5 | 🌐 Makefile | 📅 2026-03-25 - Alpine in WSL. ![github project][githublogo]
...
* [DevuanWSL](https://github.com/VPraharsha03/DevuanWSL) ⭐ 23 | 🐛 0 | 🌐 Makefile | 📅 2023-09-03 - Devuan Linux as a WSL Distro. Devuan is a Debian variant without the complexities and dependencies of systemd. ![github project][githublogo]
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,700 | 🐛 1,762 | 🌐 C++ | 📅 2026-08-27 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,527 | 🐛 339 | 🌐 Rust | 📅 2026-08-26 - A terminal emulator with focus on performance and simplicity.
...
* [extraterm](https://github.com/sedwards2009/extraterm) ⭐ 2,823 | 🐛 134 | 🌐 TypeScript | 📅 2026-06-05 - Open source project to build a terminal emulator and expand it with new features to support modern workflows. ![github project][githublogo]
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 447 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-26 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Distro Manager](https://github.com/bostrot/wsl2-distro-manager) ⭐ 3,965 | 🐛 23 | 🌐 Dart | 📅 2026-08-27 - GUI to manage, copy, distribute WSL distros. ![github project][githublogo]
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,615 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
...
* [wsl-vpnkit](https://github.com/sakai135/wsl-vpnkit) ⭐ 2,951 | 🐛 2 | 🌐 Shell | 📅 2026-08-25 - Script providing network connectivity to WSL 2 when blocked by VPN. ![github project][githublogo]
...
* [vim-wsl-copy-paste](https://github.com/Konfekt/vim-wsl-copy-paste) ⭐ 21 | 🐛 0 | 🌐 Vim script | 📅 2021-12-15 -  Adds mappings in Vim to write and read on the Windows clipboard.
  . ![github project][githublogo]
* [wip](https://github.com/slidict/wip) ⭐ 18 | 🐛 1 | 🌐 C# | 📅 2026-08-22 - A native CLI that brings dip-like development workflows to Microsoft WSL Containers (WSLC).
...
* [Files](https://github.com/files-community/Files) ⭐ 44,786 | 🐛 463 | 🌐 C# | 📅 2026-08-27 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,536 | 🐛 973 | 🌐 C++ | 📅 2026-08-27 - For reporting issues with WSL. ![github project][githublogo]
...
Portions of the descriptions above are from Wikipedia and used under [CC BY-SA 4.0 license](https://creativecommons.org/licenses/by-sa/4.0/). Portions of the descriptions above are from [Awesome-UNIX](https://github.com/sirredbeard/Awesome-UNIX) ⭐ 1,771 | 🐛 3 | 📅 2026-07-29 and used under [CC BY-SA 4.0 license](https://creativecommons.org/licenses/by-sa/4.0/).
