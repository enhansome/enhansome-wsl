...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,190 | 🐛 257 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,569 | 🐛 126 | 🌐 C++ | 📅 2026-05-27.
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,744 | 🐛 1,765 | 🌐 C++ | 📅 2026-08-28 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,559 | 🐛 338 | 🌐 Rust | 📅 2026-08-26 - A terminal emulator with focus on performance and simplicity.
...
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 447 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-30 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,643 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
* [WSL UI](https://github.com/octasoft-ltd/wsl-ui) ⭐ 375 | 🐛 60 | 🌐 TypeScript | 📅 2026-07-01 - A lightweight desktop application for managing WSL distributions built with Tauri. ![github project][githublogo]
...
* [WSL-Hello-sudo](https://github.com/nullpo-head/WSL-Hello-sudo) ⭐ 1,317 | 🐛 33 | 🌐 Rust | 📅 2023-05-21 - Use Windows Hello as your credential for `sudo`. ![github project][githublogo]
...
* [vim-wsl-copy-paste](https://github.com/Konfekt/vim-wsl-copy-paste) ⭐ 21 | 🐛 0 | 🌐 Vim script | 📅 2021-12-15 -  Adds mappings in Vim to write and read on the Windows clipboard.
  . ![github project][githublogo]
* [wip](https://github.com/slidict/wip) ⭐ 19 | 🐛 2 | 🌐 C# | 📅 2026-08-30 - A native CLI that brings dip-like development workflows to Microsoft WSL Containers (WSLC).
...
* [Files](https://github.com/files-community/Files) ⭐ 44,828 | 🐛 468 | 🌐 C# | 📅 2026-08-28 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,567 | 🐛 990 | 🌐 C++ | 📅 2026-08-30 - For reporting issues with WSL. ![github project][githublogo]
...
* [Awesome VSCode](https://github.com/viatsko/awesome-vscode) ⭐ 28,984 | 🐛 54 | 🌐 JavaScript | 📅 2026-06-21
