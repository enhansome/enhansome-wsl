...
* [WSL2-Linux-Kernel](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,557 | 🐛 134 | 🌐 C | 📅 2026-08-01 - The source for the Linux kernel used in Windows Subsystem for Linux 2.
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,435 | 🐛 256 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,636 | 🐛 126 | 🌐 C++ | 📅 2026-09-09.
...
* [ArchWSL](https://github.com/yuk7/ArchWSL) ⭐ 7,403 | 🐛 64 | 🌐 Makefile | 📅 2026-04-02 - ArchLinux in WSL. ![github project][githublogo]
* [wsldl](https://github.com/yuk7/wsldl) ⭐ 1,948 | 🐛 7 | 🌐 Go | 📅 2026-09-14 - General purpose WSL installer and launcher. ![github project][githublogo]
...
* [DevuanWSL](https://github.com/VPraharsha03/DevuanWSL) ⭐ 24 | 🐛 0 | 🌐 Makefile | 📅 2023-09-03 - Devuan Linux as a WSL Distro. Devuan is a Debian variant without the complexities and dependencies of systemd. ![github project][githublogo]
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,918 | 🐛 1,758 | 🌐 C++ | 📅 2026-09-16 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,749 | 🐛 342 | 🌐 Rust | 📅 2026-08-31 - A terminal emulator with focus on performance and simplicity.
...
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 485 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-17 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Manager](https://github.com/bostrot/wsl2-distro-manager) ⭐ 4,000 | 🐛 10 | 🌐 Dart | 📅 2026-09-13 - Free, open-source GUI for WSL: install distros from a catalogue or any Docker image, copy, move, back up and compact them, edit `.wslconfig`, mount disks, manage a remote host's WSL over SSH; optional AI assistant and MCP server. Also manages native Linux VMs on macOS. ![github project][githublogo]
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,787 | 🐛 11 | 🌐 Rust | 📅 2026-08-25 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
* [WSL UI](https://github.com/octasoft-ltd/wsl-ui) ⭐ 392 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-03 - A lightweight desktop application for managing WSL distributions built with Tauri. ![github project][githublogo]
...
* [wsl-vpnkit](https://github.com/sakai135/wsl-vpnkit) ⭐ 2,963 | 🐛 2 | 🌐 Shell | 📅 2026-09-03 - Script providing network connectivity to WSL 2 when blocked by VPN. ![github project][githublogo]
...
* [wslgit](https://github.com/andy-5/wslgit) ⭐ 1,247 | 🐛 27 | 🌐 Rust | 📅 2026-05-21 - Use git installed on WSL from Visual Studio Code on Windows. ![github project][githublogo]
* [wsl-open](https://github.com/4U6U57/wsl-open) ⭐ 553 | 🐛 8 | 🌐 Shell | 📅 2022-05-26 - Open files with xdg-open in WSL from Windows applications. ![github project][githublogo]
...
* [wip](https://github.com/slidict/wip) ⭐ 22 | 🐛 5 | 🌐 C# | 📅 2026-09-15 - A native CLI that brings dip-like development workflows to Microsoft WSL Containers (WSLC).
...
* [Files](https://github.com/files-community/Files) ⭐ 45,493 | 🐛 462 | 🌐 C# | 📅 2026-09-17 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [marcop135/dotfiles-core](https://github.com/marcop135/dotfiles-core) ⭐ 0 | 🐛 0 | 🌐 Shell | 📅 2026-09-14 - Manifest-driven dotfiles for WSL bash plus native Windows (Git Bash, PowerShell) and macOS zsh; one shared sh layer, dry-run installers. ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,721 | 🐛 981 | 🌐 C++ | 📅 2026-09-17 - For reporting issues with WSL. ![github project][githublogo]
...
* [Awesome VSCode](https://github.com/viatsko/awesome-vscode) ⭐ 29,040 | 🐛 62 | 🌐 JavaScript | 📅 2026-06-21
