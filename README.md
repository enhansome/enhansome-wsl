...
* [WSL2-Linux-Kernel](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,549 | 🐛 134 | 🌐 C | 📅 2026-08-01 - The source for the Linux kernel used in Windows Subsystem for Linux 2.
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,192 | 🐛 257 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,573 | 🐛 127 | 🌐 C++ | 📅 2026-05-27.
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,762 | 🐛 1,767 | 🌐 C++ | 📅 2026-08-28 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,569 | 🐛 338 | 🌐 Rust | 📅 2026-08-26 - A terminal emulator with focus on performance and simplicity.
...
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 448 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-31 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Distro Manager](https://github.com/bostrot/wsl2-distro-manager) ⭐ 3,968 | 🐛 23 | 🌐 Dart | 📅 2026-08-31 - GUI to manage, copy, distribute WSL distros. ![github project][githublogo]
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,656 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
...
* [wsl-vpnkit](https://github.com/sakai135/wsl-vpnkit) ⭐ 2,951 | 🐛 3 | 🌐 Shell | 📅 2026-08-25 - Script providing network connectivity to WSL 2 when blocked by VPN. ![github project][githublogo]
* [WSL-Hello-sudo](https://github.com/nullpo-head/WSL-Hello-sudo) ⭐ 1,318 | 🐛 33 | 🌐 Rust | 📅 2023-05-21 - Use Windows Hello as your credential for `sudo`. ![github project][githublogo]
...
* [claude-code-wsl2-setup](https://github.com/congmnguyen/claude-code-wsl2-setup) ⭐ 47 | 🐛 1 | 🌐 Shell | 📅 2026-08-31 - Claude Code setup for WSL2 + Windows Terminal: Codex delegation, screenshot paste as WSL paths, Windows notifications, LSP wiring, statusline, and safety/context hygiene hooks. ![github project][githublogo]
...
* [Files](https://github.com/files-community/Files) ⭐ 44,838 | 🐛 460 | 🌐 C# | 📅 2026-08-31 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,581 | 🐛 989 | 🌐 C++ | 📅 2026-08-31 - For reporting issues with WSL. ![github project][githublogo]
...
* [Awesome VSCode](https://github.com/viatsko/awesome-vscode) ⭐ 28,990 | 🐛 54 | 🌐 JavaScript | 📅 2026-06-21
