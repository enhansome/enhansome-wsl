# Awesome WSL - Windows Subsystem for Linux with stars
...
* [WSL2-Linux-Kernel](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,528 | 🐛 136 | 🌐 C | 📅 2026-08-01 - The source for the Linux kernel used in Windows Subsystem for Linux 2.
...
* [Windows-Subsystem-For-Linux-Setup](https://github.com/michaeltreat/Windows-Subsystem-For-Linux-Setup) ⭐ 626 | 🐛 0 | 📅 2022-01-14 - A basic guide for how to get setup with the WSL feature that is included with Windows 10. ![github project][githublogo]
...
Yes, a [suprising number](https://github.com/ethanhs/WSL-Programs) ⚠️ Archived of Linux GUI apps can run on WSL. GUI applications are officially supported on WSL2 with Windows Insider Preview since Windows 10 Insider Preview build 21286. It will also be available in Windows 10's fall 2021 release, and Windows 11. The GUI capabilities of WSL2 are informally referred to as WSLg.
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,113 | 🐛 256 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
* [WSL as a Development Environment](https://github.com/hsab/WSL-config) ⭐ 167 | 🐛 1 | 🌐 Vim script | 📅 2017-05-13 - From the computer science department at University of Utah. ![github project][githublogo]
* [ubuntu-win-boostrap](https://github.com/seapagan/ubuntu-win-bootstrap) ⚠️ Archived - A very simple bootstrap script to install some development basic tools on Debian/Ubuntu on WSL. ![github project][githublogo]
...
To learn more about programming generally, visit [curated-programming-resources](https://github.com/Michael0x2a/curated-programming-resources/blob/master/resources.md) ⭐ 3,244 | 🐛 29 | 📅 2026-02-05.
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,477 | 🐛 127 | 🌐 C++ | 📅 2026-05-27.
...
* Replacing Windows shell [with Xfce, Gnome, KDE, or i3.](https://github.com/NathanCastle/BootShellCredentialProvider) ⭐ 784 | 🐛 7 | 🌐 C++ | 📅 2021-01-12.
...
* [Fedora Remix for WSL GitHub](https://github.com/WhitewaterFoundry/WSLFedoraRemix) ⭐ 812 | 🐛 65 | 🌐 C++ | 📅 2026-03-08 ![github project][githublogo]
...
* [Pengwin GitHub](https://github.com/WhitewaterFoundry/Pengwin) ⭐ 1,520 | 🐛 93 | 🌐 C++ | 📅 2026-02-13 ![github project][githublogo]
...
* [Pengwin Enterprise GitHub](https://github.com/WhitewaterFoundry/Pengwin-Enterprise) ⭐ 69 | 🐛 7 | 🌐 C++ | 📅 2025-12-22 ![github project][githublogo]
...
* [ArchWSL](https://github.com/yuk7/ArchWSL) ⭐ 7,389 | 🐛 64 | 🌐 Makefile | 📅 2026-04-02 - ArchLinux in WSL. ![github project][githublogo]
* [wsldl](https://github.com/yuk7/wsldl) ⭐ 1,944 | 🐛 8 | 🌐 Go | 📅 2026-07-13 - General purpose WSL installer and launcher. ![github project][githublogo]
* [WSL-Distribution-Switcher](https://github.com/RoliSoft/WSL-Distribution-Switcher) ⭐ 1,667 | 🐛 45 | 🌐 Python | 📅 2022-01-25 - Scripts to replace the distribution behind WSL with any other Linux distribution published on [Docker Hub](https://hub.docker.com/explore/). Includes alpine, CentOS, Fedora, Clear, and others. ![github project][githublogo]
* [CentWSL](https://github.com/yuk7/CentWSL) ⚠️ Archived - CentOS as a WSL distro. ![github project][githublogo]
* [AlpineWSL](https://github.com/yuk7/AlpineWSL) ⭐ 656 | 🐛 5 | 🌐 Makefile | 📅 2026-03-25 - Alpine in WSL. ![github project][githublogo]
...
* [FedoraWSL](https://github.com/yosukes-dev/FedoraWSL) ⭐ 140 | 🐛 0 | 🌐 Makefile | 📅 2023-01-24 - Fedora as a WSL distro. ![github project][githublogo]
...
* [AmazonWSL](https://github.com/yosukes-dev/AmazonWSL) ⭐ 121 | 🐛 6 | 🌐 Makefile | 📅 2024-01-10 - Amazon Linux as a WSL distro. ![github project][githublogo]
* [WSLackware](https://github.com/Mohsens22/WSLackware) ⭐ 71 | 🐛 2 | 🌐 C++ | 📅 2024-08-21 - Slackware as a WSL distro. ![github project][githublogo]
* [acme-wsl](https://github.com/elrzn/acme-wsl) ⭐ 46 | 🐛 1 | 🌐 Shell | 📅 2019-05-18 - Install acme / plan9port on Debian, Ubuntu, or Kali Linux distributions on WSL.
* [GentooWSL](https://github.com/imaandrew/GentooWSL) ⚠️ Archived - Gentoo as a WSL distro. ![github project][githublogo]
* [DevuanWSL](https://github.com/VPraharsha03/DevuanWSL) ⭐ 22 | 🐛 0 | 🌐 Makefile | 📅 2023-09-03 - Devuan Linux as a WSL Distro. Devuan is a Debian variant without the complexities and dependencies of systemd. ![github project][githublogo]
* [ManjaroWSL2](https://github.com/sileshn/ManjaroWSL2) ⭐ 3 | 🐛 0 | 🌐 Shell | 📅 2026-08-01 - Manjaro as a WSL2 distro based on wsldl. ![github project][githublogo]
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,614 | 🐛 1,736 | 🌐 C++ | 📅 2026-08-13 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,376 | 🐛 338 | 🌐 Rust | 📅 2026-08-03 - A terminal emulator with focus on performance and simplicity.
...
* [wsltty](https://github.com/mintty/wsltty) ⭐ 3,197 | 🐛 26 | 🌐 C | 📅 2025-09-02 - Mintty as a terminal for WSL. ![github project][githublogo]
* [wsl-terminal](https://github.com/goreliu/wsl-terminal) ⭐ 3,125 | 🐛 29 | 🌐 Shell | 📅 2020-09-11 - A terminal emulator for WSL, based on mintty, fatty and wslbridge. ![github project][githublogo]
* [extraterm](https://github.com/sedwards2009/extraterm) ⭐ 2,821 | 🐛 134 | 🌐 TypeScript | 📅 2026-06-05 - Open source project to build a terminal emulator and expand it with new features to support modern workflows. ![github project][githublogo]
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 437 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-15 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Distro Manager](https://github.com/bostrot/wsl2-distro-manager) ⭐ 3,957 | 🐛 23 | 🌐 Dart | 📅 2026-04-14 - GUI to manage, copy, distribute WSL distros. ![github project][githublogo]
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,439 | 🐛 14 | 🌐 Rust | 📅 2026-07-20 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
* [WSL UI](https://github.com/octasoft-ltd/wsl-ui) ⭐ 350 | 🐛 59 | 🌐 TypeScript | 📅 2026-07-01 - A lightweight desktop application for managing WSL distributions built with Tauri. ![github project][githublogo]
...
* [wsl-vpnkit](https://github.com/sakai135/wsl-vpnkit) ⭐ 2,945 | 🐛 4 | 🌐 Shell | 📅 2026-08-14 - Script providing network connectivity to WSL 2 when blocked by VPN. ![github project][githublogo]
* [WSL-Hello-sudo](https://github.com/nullpo-head/WSL-Hello-sudo) ⭐ 1,314 | 🐛 33 | 🌐 Rust | 📅 2023-05-21 - Use Windows Hello as your credential for `sudo`. ![github project][githublogo]
* [wslgit](https://github.com/andy-5/wslgit) ⭐ 1,241 | 🐛 27 | 🌐 Rust | 📅 2026-05-21 - Use git installed on WSL from Visual Studio Code on Windows. ![github project][githublogo]
...
* [is-wsl for Node](https://github.com/sindresorhus/is-wsl) ⭐ 198 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-15 - Check if the current process is running inside Windows Subsystem for Linux, useful for scripting. ![github project][githublogo]
...
* [wslpath](https://github.com/laurent22/wslpath) ⭐ 121 | 🐛 6 | 🌐 PHP | 📅 2018-04-27 - Easily convert Windows to WSL path names and vice-versa. ![github project][githublogo]
* [OpenInWSL](https://github.com/Opticos/OpenInWSL-Source) ⭐ 111 | 🐛 12 | 🌐 Python | 📅 2024-07-27 - Easily Make WSL Linux Apps Windows File Handlers. ![github project][githublogo]
* [pinentry-wsl-ps1](https://github.com/diablodale/pinentry-wsl-ps1) ⭐ 107 | 🐛 8 | 🌐 Shell | 📅 2023-03-10 - Store passwords for gpg-agent in Windows Credential Manager ![github project][githublogo]
* [wslpy](https://github.com/wslutilities/wslpy) ⚠️ Archived - A Python3 library for WSL specific tasks. ![github project][githublogo]
* [xclip-xsel-WSL](https://github.com/Konfekt/xclip-xsel-WSL) ⭐ 72 | 🐛 0 | 🌐 Shell | 📅 2022-11-02 -  Make `xclip` and `xsel` in `WSL` read and write on the Windows instead of the Linux clipboard.
...
* [Porthole](https://github.com/celloza/porthole) ⭐ 14 | 🐛 5 | 🌐 C# | 📅 2026-08-09 - A native Windows desktop dashboard for WSL Containers with tray-hosted backend operations. ![github project][githublogo]
...
* [wsl-open](https://github.com/jbwfu/wsl-open) ⭐ 2 | 🐛 0 | 🌐 Go | 📅 2025-09-10 - A Go utility for WSL to open files, directories, and URLs in their default Windows applications. ![github project][githublogo]
...
* [claude-code-wsl2-setup](https://github.com/congmnguyen/claude-code-wsl2-setup) ⭐ 45 | 🐛 0 | 🌐 Shell | 📅 2026-08-10 - Claude Code setup for WSL2 + Windows Terminal: Codex delegation, screenshot paste as WSL paths, Windows notifications, LSP wiring, statusline, and safety/context hygiene hooks. ![github project][githublogo]

#### Miscellaneous Tools

* [Files](https://github.com/files-community/Files) ⭐ 44,628 | 🐛 461 | 🌐 C# | 📅 2026-08-14 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [cmd-colors-solarized](https://github.com/neilpa/cmd-colors-solarized) ⭐ 1,111 | 🐛 11 | 🌐 PowerShell | 📅 2021-09-29 - This is a solarized color scheme for the Windows command prompt that works in WSL.
...
* [WinCryptSSHAgent](https://github.com/buptczq/WinCryptSSHAgent) ⭐ 586 | 🐛 41 | 🌐 Go | 📅 2024-06-06 - Using a Yubikey for SSH Authentication on Windows Seamlessly.  Supports WSL and WSL2.
* [easyWSL](https://github.com/redcode-labs/easyWSL) ⭐ 578 | 🐛 15 | 🌐 C# | 📅 2024-11-17 - Use any Docker image as a WSL distro. ![github project][githublogo]
* [wsl2-ssh-pageant](https://github.com/BlackReloaded/wsl2-ssh-pageant) ⚠️ Archived - A bridge between Windows Pageant and WSL2.
* [wslbridge](https://github.com/rprichard/wslbridge) ⭐ 352 | 🐛 31 | 🌐 C++ | 📅 2020-09-16 - wslbridge is a Cygwin program that allows connecting to the WSL command-line environment over TCP sockets, as with ssh, but without the overhead of configuring an SSH server. ![github project][githublogo]
* [wsl-dotfiles](https://github.com/Xyene/wsl-dotfiles) ⭐ 270 | 🐛 0 | 🌐 Shell | 📅 2020-02-12 - Configuration files and scripts for creating an i3-based environment inside WSL. ![github project][githublogo]
* [WSLInstall](https://github.com/Biswa96/WSLInstall) ⭐ 254 | 🐛 2 | 🌐 C | 📅 2020-10-23 - Install any Linux distribution userspace in WSL with compressed RootFS tarballs (tar.gz) or with Docker containers or with ISO files. ![github project][githublogo]
* [weasel-pageant](https://github.com/vuori/weasel-pageant) ⚠️ Archived - An ssh-agent compatible helper for interacting with Pageant from processes running on the Windows Subsystem for Linux.
* [setup-wsl](https://github.com/Vampire/setup-wsl) ⭐ 142 | 🐛 1 | 🌐 Kotlin | 📅 2026-07-14 - A GitHub action to install and setup a Linux distribution for the Windows Subsystem for Linux (WSL). ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,407 | 🐛 973 | 🌐 C++ | 📅 2026-08-15 - For reporting issues with WSL. ![github project][githublogo]
...
* [Awesome VSCode](https://github.com/viatsko/awesome-vscode) ⭐ 28,961 | 🐛 45 | 🌐 JavaScript | 📅 2026-06-21
* [Awesome Bash](https://github.com/awesome-lists/awesome-bash) ⭐ 9,991 | 🐛 6 | 🌐 Shell | 📅 2026-05-21
...
Portions of the descriptions above are from Wikipedia and used under [CC BY-SA 4.0 license](https://creativecommons.org/licenses/by-sa/4.0/). Portions of the descriptions above are from [Awesome-UNIX](https://github.com/sirredbeard/Awesome-UNIX) ⭐ 1,768 | 🐛 3 | 📅 2026-07-29 and used under [CC BY-SA 4.0 license](https://creativecommons.org/licenses/by-sa/4.0/).
