...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,218 | 🐛 257 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,588 | 🐛 126 | 🌐 C++ | 📅 2026-05-27.
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,787 | 🐛 1,758 | 🌐 C++ | 📅 2026-09-03 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,607 | 🐛 338 | 🌐 Rust | 📅 2026-08-31 - A terminal emulator with focus on performance and simplicity.
...
* [extraterm](https://github.com/sedwards2009/extraterm) ⭐ 2,825 | 🐛 134 | 🌐 TypeScript | 📅 2026-06-05 - Open source project to build a terminal emulator and expand it with new features to support modern workflows. ![github project][githublogo]
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 448 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-03 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Distro Manager](https://github.com/bostrot/wsl2-distro-manager) ⭐ 3,970 | 🐛 22 | 🌐 Dart | 📅 2026-08-31 - GUI to manage, copy, distribute WSL distros. ![github project][githublogo]
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,684 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
* [WSL UI](https://github.com/octasoft-ltd/wsl-ui) ⭐ 378 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-03 - A lightweight desktop application for managing WSL distributions built with Tauri. ![github project][githublogo]
...
* [wsl-vpnkit](https://github.com/sakai135/wsl-vpnkit) ⭐ 2,949 | 🐛 2 | 🌐 Shell | 📅 2026-09-03 - Script providing network connectivity to WSL 2 when blocked by VPN. ![github project][githublogo]
...
* [claude-code-wsl2-setup](https://github.com/congmnguyen/claude-code-wsl2-setup) ⭐ 48 | 🐛 1 | 🌐 Shell | 📅 2026-08-31 - Claude Code setup for WSL2 + Windows Terminal: Codex delegation, screenshot paste as WSL paths, Windows notifications, LSP wiring, statusline, and safety/context hygiene hooks. ![github project][githublogo]
...
* [Files](https://github.com/files-community/Files) ⭐ 44,866 | 🐛 462 | 🌐 C# | 📅 2026-09-03 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,611 | 🐛 990 | 🌐 C++ | 📅 2026-09-03 - For reporting issues with WSL. ![github project][githublogo]
...
* [Awesome Shell](https://github.com/alebcay/awesome-shell) ⭐ 37,553 | 🐛 184 | 📅 2025-08-28
* [Awesome VSCode](https://github.com/viatsko/awesome-vscode) ⭐ 28,998 | 🐛 55 | 🌐 JavaScript | 📅 2026-06-21
