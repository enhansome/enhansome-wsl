...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,179 | 🐛 257 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,556 | 🐛 126 | 🌐 C++ | 📅 2026-05-27.
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,705 | 🐛 1,763 | 🌐 C++ | 📅 2026-08-27 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,534 | 🐛 339 | 🌐 Rust | 📅 2026-08-26 - A terminal emulator with focus on performance and simplicity.
...
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 447 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-27 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,619 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
...
* [Files](https://github.com/files-community/Files) ⭐ 44,787 | 🐛 460 | 🌐 C# | 📅 2026-08-27 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [easyWSL](https://github.com/redcode-labs/easyWSL) ⭐ 576 | 🐛 15 | 🌐 C# | 📅 2024-11-17 - Use any Docker image as a WSL distro. ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,539 | 🐛 976 | 🌐 C++ | 📅 2026-08-27 - For reporting issues with WSL. ![github project][githublogo]
...
* [Awesome VSCode](https://github.com/viatsko/awesome-vscode) ⭐ 28,975 | 🐛 53 | 🌐 JavaScript | 📅 2026-06-21
