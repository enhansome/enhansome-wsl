...
* [WSL2-Linux-Kernel](https://github.com/microsoft/WSL2-Linux-Kernel) ⭐ 10,542 | 🐛 134 | 🌐 C | 📅 2026-08-01 - The source for the Linux kernel used in Windows Subsystem for Linux 2.
...
* [The Art of Command Line](https://github.com/jlevy/the-art-of-command-line) ⭐ 162,167 | 🐛 258 | 📅 2024-06-25 - Master the command line in one page. ![github project][githublogo]
...
You can test the install after following the above steps through PyTorch (`torch.cuda.is_available()`) or similar tools. Another option is using the [NVIDIA CUDA Samples](https://github.com/NVIDIA/cuda-samples) ⭐ 9,552 | 🐛 125 | 🌐 C++ | 📅 2026-05-27.
...
* [ArchWSL](https://github.com/yuk7/ArchWSL) ⭐ 7,397 | 🐛 64 | 🌐 Makefile | 📅 2026-04-02 - ArchLinux in WSL. ![github project][githublogo]
...
* [AlpineWSL](https://github.com/yuk7/AlpineWSL) ⭐ 658 | 🐛 5 | 🌐 Makefile | 📅 2026-03-25 - Alpine in WSL. ![github project][githublogo]
...
* [Windows Terminal](https://github.com/microsoft/terminal) ⭐ 104,694 | 🐛 1,756 | 🌐 C++ | 📅 2026-08-26 - The new open-source Windows Terminal. ![github\_project][githublogo]
* [Alacritty](https://github.com/alacritty/alacritty) ⭐ 65,513 | 🐛 339 | 🌐 Rust | 📅 2026-08-26 - A terminal emulator with focus on performance and simplicity.
...
* [extraterm](https://github.com/sedwards2009/extraterm) ⭐ 2,822 | 🐛 134 | 🌐 TypeScript | 📅 2026-06-05 - Open source project to build a terminal emulator and expand it with new features to support modern workflows. ![github project][githublogo]
* [KKTerm](https://github.com/ryantsai/KKTerm) ⭐ 447 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-26 - A Windows-first, local-first terminal for managing connections, sessions, and workspaces.
...
* [WSL Dashboard](https://github.com/owu/wsl-dashboard) ⭐ 3,603 | 🐛 8 | 🌐 Rust | 📅 2026-08-25 - A modern, lightweight GUI dashboard for managing WSL distributions. ![github project][githublogo]
* [WSL UI](https://github.com/octasoft-ltd/wsl-ui) ⭐ 365 | 🐛 60 | 🌐 TypeScript | 📅 2026-07-01 - A lightweight desktop application for managing WSL distributions built with Tauri. ![github project][githublogo]
...
* [wsl-vpnkit](https://github.com/sakai135/wsl-vpnkit) ⭐ 2,952 | 🐛 2 | 🌐 Shell | 📅 2026-08-25 - Script providing network connectivity to WSL 2 when blocked by VPN. ![github project][githublogo]
...
* [Files](https://github.com/files-community/Files) ⭐ 44,767 | 🐛 460 | 🌐 C# | 📅 2026-08-26 - A modern file explorer that supports WSL filesystem. ![github project][githublogo]
...
* [easyWSL](https://github.com/redcode-labs/easyWSL) ⭐ 577 | 🐛 15 | 🌐 C# | 📅 2024-11-17 - Use any Docker image as a WSL distro. ![github project][githublogo]
...
* [WSL on GitHub](https://github.com/Microsoft/WSL) ⭐ 33,523 | 🐛 977 | 🌐 C++ | 📅 2026-08-26 - For reporting issues with WSL. ![github project][githublogo]
...
* [Awesome VSCode](https://github.com/viatsko/awesome-vscode) ⭐ 28,972 | 🐛 51 | 🌐 JavaScript | 📅 2026-06-21
* [Awesome Bash](https://github.com/awesome-lists/awesome-bash) ⭐ 10,046 | 🐛 9 | 🌐 Shell | 📅 2026-05-21
...
* [Awesome UNIX](https://github.com/sirredbeard/Awesome-UNIX) ⭐ 1,770 | 🐛 3 | 📅 2026-07-29
...
Portions of the descriptions above are from Wikipedia and used under [CC BY-SA 4.0 license](https://creativecommons.org/licenses/by-sa/4.0/). Portions of the descriptions above are from [Awesome-UNIX](https://github.com/sirredbeard/Awesome-UNIX) ⭐ 1,770 | 🐛 3 | 📅 2026-07-29 and used under [CC BY-SA 4.0 license](https://creativecommons.org/licenses/by-sa/4.0/).
